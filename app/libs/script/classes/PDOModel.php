...
class PDOModel
{
    ...
    public function connect($hostName, $userName, $password, $databaseName, $dbType = "mysql", $charset = "utf8")
    {
        ...
        switch ($this->dbType) {
            ...
            case "sqlserver":
                ...
                break;
            default:
                $this->setErrors("Please enter valid database type option. Available options are mysql, pgsql and sqlite");
                return false;
        }
    ...
    private function connectOracle()
    {
        ...
        try {
            $this->dbObj = new PDO("oci:host=$this->dbHostName;dbname=$this->dbName", $this->dbUserName, $this->dbPassword);
            $this->connectionStatus = 1;
        } catch (PDOException $e) {
            $this->setErrors($e->getMessage());
        }
    ...
    public function send_email_public($to, $from, $file = null, $subject = null, $message = '', $cc1 = null, $cc2 = null, $html = true)
    {
