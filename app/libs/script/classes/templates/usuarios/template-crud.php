        ...
        <div class="page-title clearfix card-header pdocrud-table-heading">
            ...
            <?php if ($settings["addbtn"]) { ?>
                <div class="btn-group float-right">
                    <a title="<?php echo $lang["add"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-add green btn btn-success" href="javascript:;" data-action="add" data-obj-key="<?php echo $objKey; ?>">
            ...
            if (isset($extraData["btnTopAction"]) && is_array($extraData["btnTopAction"]) && count($extraData["btnTopAction"])) {
                ...
                ?>
                    <div class="btn-group float-right">
                        <a title="<?php echo $text; ?>" class="pdocrud-top-actions pdocrud-button <?php echo $cssClass; ?> pdocrud-button-<?php echo $action_name; ?>" href="<?php echo $url; ?>" data-action="<?php echo $action_name; ?>" data-obj-key="<?php echo $objKey; ?>">
                            <?php echo $text; ?>
                        </a>
                    </div>
            <?php }
                ...
                <div class="row" style="padding-bottom: 5px">
                    <?php foreach ($extraData["dateRangeReport"] as $key => $dateRange) { ?>
                        <div class="col-md-2 col-lg-2">
                            <a title="<?php echo $dateRange["text"]; ?>" class="pdocrud-actions pdocrud-button  btn btn-success pdocrud-date-range-report" href="javascript:;" data-action="date_range_report" data-action-id="<?php echo $key; ?>" data-obj-key="<?php echo $objKey; ?>">
            ...
            <div class="row pdocrud-options-files">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <ul class="pdocrud-export-options">
                        ...
                        if ($settings["csvBtn"]) {
                        ?>
                            <li><a title="<?php echo $lang["csv"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="csv" data-objkey="<?php echo $objKey; ?>"><i class="fa fa-file-o"></i> <?php echo $lang["csv"]; ?></a></li>
                        <?php
                        }
                        if ($settings["pdfBtn"]) {
                        ?>
                        ...
                        if ($settings["excelBtn"]) { ?>
                            <li><a title="<?php echo $lang["excel"]; ?>" class="pdocrud-actions pdocrud-button pdocrud-button-export" href="javascript:;" data-action="exporttable" data-export-type="excel" data-objkey="<?php echo $objKey; ?>"><i class="fa fa-file-excel"></i> <?php echo $lang["excel"]; ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
